...
var incompleteTaskHolder=document.getElementById("task-list-section");//ul of #task-list-section
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task task-input-field";

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.className="task-button edit-task";

  deleteButton.className="task-button delete-task";
...
//Mark task as incomplete.
  ...
  //Append the task list item to the #task-list-section.
  var listItem=this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem,taskCompleted);
}
